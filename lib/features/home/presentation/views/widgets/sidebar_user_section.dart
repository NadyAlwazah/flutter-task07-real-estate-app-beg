...
class SidebarUserSection extends StatefulWidget {
  const SidebarUserSection({super.key, required this.onItemSelected});
  final ValueChanged<int> onItemSelected;
  @override
  State<SidebarUserSection> createState() => _SidebarUserSectionState();
}

class _SidebarUserSectionState extends State<SidebarUserSection> {
  int selectedIndex = 0;

  final List<SidebarMenuItem> menuItems = [
    SidebarMenuItem('Properties', Icons.home_work_outlined),
    SidebarMenuItem('Favorites', Icons.favorite_border),
    SidebarMenuItem('Profile', Icons.person_pin),
  ];
        ...
        child: Column(
          ...
          children: [
            ...
            BlocListener<AuthCubit, AuthState>(
              ...
              child: ListTile(
                leading: Icon(size: 25.r, Icons.logout, color: Colors.red),
